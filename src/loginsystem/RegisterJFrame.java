...
public class RegisterJFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        User temp = new User(jTextField1.getText(),jTextField3.getText(),1023904,Integer.parseInt(jTextField4.getText()),jTextField5.getText(),jTextField6.getText());
        int registered = r.registerUser(temp);
        if(registered == 0){
